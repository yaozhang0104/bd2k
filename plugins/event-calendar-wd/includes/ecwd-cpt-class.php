...
class ECWD_Cpt {
    ...
    public function setup_cpt() {
        ...
        $organizers_args = array(
            ...
            'capabilities' => array(
                'publish_posts' => 'publish_organizers',
                'edit_posts' => 'edit_organizers',
                'edit_others_posts' => 'edit_others_organizers',
                'edit_published_posts' => 'edit_published_organizers', 
                'delete_posts' => 'delete_organizers',
                'delete_others_posts' => 'delete_others_organizers',
                'delete_published_posts' => 'delete_published_organizers',
                'read_private_posts' => 'read_private_organizers',
                'edit_private_posts' => 'edit_private_organizers',
                'delete_private_posts' => 'delete_private_organizers',
                'edit_post' => 'edit_organizer',
                'delete_post' => 'delete_organizer',
                'read_post' => 'read_organizer',
            ),
            'taxonomies' => array(),
            'has_archive' => true,
            'hierarchical' => true,
