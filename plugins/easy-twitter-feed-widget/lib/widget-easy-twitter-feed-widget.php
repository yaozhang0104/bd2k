				...
				<?php endif; ?>
	          	...
	          	<div class="widget-easy-twitter-feed-widget-row">
			          ...
			          <div class="twitter-block">
						<a class="twitter-timeline" cards="hidden" width="<?php echo $instance['twitter_widget_width']; ?>" height="<?php echo $instance['twitter_widget_height']; ?>" href="https://twitter.com/twitterdev" <?php echo trim( $data_twitter_widget_nv ); ?>><?php _e( 'Tweets by @', 'kamn-easy-twitter-feed-widget' ); ?><?php echo $instance['twitter_widget_screen_name']; ?></a>
						</div>
			          </div>
	          		</div>
          		</div>
