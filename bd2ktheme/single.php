...
<div style="width:20%;display:inline-block;vertical-align:top;margin-left:25px;font-family:roboto;font-size:14px;height:1400px;">

<div>
<div style="font-size:22px;">Categories</div><div class="hline" style="margin-bottom:3px;"></div>
<ul>
<li style="margin-bottom:3px;"><a href=<?php echo "'" . get_home_url() . "/index.php/event'"?>>Events</a></li>
<li style="margin-bottom:3px;"><a href=<?php echo "'" . get_home_url() . "/index.php/category/news'"?>>News</a></li>
<li style="margin-bottom:3px;"><a href=<?php echo "'" . get_home_url() . "/index.php/category/software'"?>>Software</a></li>
<li style="margin-bottom:3px;"><a href=<?php echo "'" . get_home_url() . "/index.php/category/uncategorized'"?>>Uncategorized</a></li>
</ul>
</div>

<div>
<div style="font-size:22px;">Recent Comments</div><div class="hline" style="margin-bottom:3px;"></div>
<ul>
<?php
$args = array(
    'number' => '5',
...
foreach($comments as $comment) :
    echo '<li>' . $comment->comment_author . ' on <a href=' . get_permalink($comment->comment_post_ID) . '>' . get_post($comment->comment_post_ID)->post_title . '</a></li>';
endforeach;
?>
</ul>
</div>
...
<div>
<div style="font-size:22px;">Highlights</div><div class="hline" style="margin-bottom:3px;"></div>
<ul>
<?php
$args = array( 'posts_per_page' => 5, 'tag' => 'highlight');
$postslist = get_posts( $args );
foreach ( $postslist as $post ) :
  setup_postdata( $post ); ?> 
    <li style="margin-bottom:3px;">
        <a href=<?php the_permalink();?> style="color:#4a4a4a"><?php the_title(); ?></a>
    </li>
<?php
endforeach; 
wp_reset_postdata();
...
<div>
<div style="font-size:22px;">Archives</div><div class="hline" style="margin-bottom:3px;"></div>
