...
<div id="primary" class="<?php evolve_layout_class($type = 1); ?>">
    ...
    <?php } elseif (is_tag()) { ?>
<!-- changed -->
    <?php if (single_tag_title("", false) != "highlight") { ?>
        <h2 class="page-title archive-title"><?php _e('Posts tagged', 'evolve'); ?> <span id="tag-title"><?php single_tag_title(); ?></span></h2>
    <?php } 
    else { ?>
        <div style="width:150px;display:inline-block;float:left;margin-left:15px;vertical-align:top;">
        <h2 class="page-title archive-title"><span id="tag-title">Highlight</span></h2>
        </div>
        <div style="width:140px;display:inline-block;float:right;vertical-align:top;">
