...
if ( function_exists('register_sidebar') )
        register_sidebar(array(
            'name' => __('tw_bar', 'evolve'),
            'id' => 'tw_bar',
            'before_widget' => '<div id="twtr">',
            'after_widget' => '</div>',
            'before_title' => '<div style="font-size:22px;"><a href="https://twitter.com/BD2K_CCC" style="color:#4a4a4a;">',
            'after_title' => '</a><div class="hline"></div></div><div style="height:6px;"></div>',
        ));
